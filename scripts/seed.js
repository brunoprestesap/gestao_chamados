...
db.servicecatalogs.insertMany([
  ...
  { code: "ELET-0001", name: "Troca de lâmpada", description: "Substituição de lâmpadas queimadas ou com defeito", typeId: tPredial, subtypeId: stEletrica, priorityDefault: "Baixa", estimatedHours: 1, materials: "Lâmpada compatível", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "ELET-0002", name: "Reparo de tomada", description: "Conserto ou substituição de tomada elétrica", typeId: tPredial, subtypeId: stEletrica, priorityDefault: "Normal", estimatedHours: 1, materials: "Tomada, fios", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "ELET-0003", name: "Reparo em quadro elétrico", description: "Manutenção de disjuntores e quadro de distribuição", typeId: tPredial, subtypeId: stEletrica, priorityDefault: "Alta", estimatedHours: 3, materials: "Disjuntores, fios", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  // Manutenção Predial > Hidráulica
  { code: "HIDR-0001", name: "Reparo de vazamento", description: "Identificação e correção de vazamentos", typeId: tPredial, subtypeId: stHidraulica, priorityDefault: "Alta", estimatedHours: 2, materials: "Vedantes, tubos", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "HIDR-0002", name: "Desentupimento de ralo/vaso", description: "Desobstrução de ralos, vasos sanitários e tubulações", typeId: tPredial, subtypeId: stHidraulica, priorityDefault: "Normal", estimatedHours: 2, materials: "Desentupidor, soda", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "HIDR-0003", name: "Troca de torneira", description: "Substituição de torneira com defeito", typeId: tPredial, subtypeId: stHidraulica, priorityDefault: "Baixa", estimatedHours: 1, materials: "Torneira, fita veda-rosca", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  // Manutenção Predial > Civil
  { code: "CIVL-0001", name: "Pintura de ambiente", description: "Pintura de paredes e tetos", typeId: tPredial, subtypeId: stCivil, priorityDefault: "Baixa", estimatedHours: 8, materials: "Tinta, rolo, massa corrida", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "CIVL-0002", name: "Reparo em alvenaria", description: "Correção de trincas, buracos e danos em paredes", typeId: tPredial, subtypeId: stCivil, priorityDefault: "Normal", estimatedHours: 4, materials: "Cimento, argamassa", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "CIVL-0003", name: "Reparo de piso", description: "Substituição ou reparo de pisos danificados", typeId: tPredial, subtypeId: stCivil, priorityDefault: "Normal", estimatedHours: 4, materials: "Piso, argamassa, rejunte", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  // Manutenção Predial > Marcenaria
  { code: "MARC-0001", name: "Reparo de mobiliário", description: "Conserto de mesas, cadeiras, armários e estantes", typeId: tPredial, subtypeId: stMarcenaria, priorityDefault: "Baixa", estimatedHours: 3, materials: "Parafusos, cola, dobradiças", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "MARC-0002", name: "Confecção de móvel sob medida", description: "Fabricação de móvel personalizado", typeId: tPredial, subtypeId: stMarcenaria, priorityDefault: "Normal", estimatedHours: 16, materials: "MDF, dobradiças, puxadores", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  // Manutenção Predial > TI e Infraestrutura
  { code: "INFR-0001", name: "Reparo de ponto de rede", description: "Conectorização e teste de ponto de rede", typeId: tPredial, subtypeId: stTI, priorityDefault: "Normal", estimatedHours: 2, materials: "Conector RJ45, cabo CAT6", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  { code: "INFR-0002", name: "Remanejamento de equipamento", description: "Realocação de computadores, impressoras e periféricos", typeId: tPredial, subtypeId: stTI, priorityDefault: "Baixa", estimatedHours: 2, materials: "", procedure: "", isActive: true, createdAt: now, updatedAt: now },
  // Ar-Condicionado
...
db.sla_configs.insertMany([
  { priority: "BAIXA", responseTargetMinutes: 480, resolutionTargetMinutes: 2880, businessHoursOnly: true, isActive: true, version: "1.0", createdAt: now, updatedAt: now },
  { priority: "NORMAL", responseTargetMinutes: 240, resolutionTargetMinutes: 1440, businessHoursOnly: true, isActive: true, version: "1.0", createdAt: now, updatedAt: now },
  { priority: "ALTA", responseTargetMinutes: 120, resolutionTargetMinutes: 480, businessHoursOnly: true, isActive: true, version: "1.0", createdAt: now, updatedAt: now },
  { priority: "EMERGENCIAL", responseTargetMinutes: 30, resolutionTargetMinutes: 120, businessHoursOnly: false, isActive: true, version: "1.0", createdAt: now, updatedAt: now },
]);
...
db.holidays.insertMany([
  { date: "2026-01-01", name: "Confraternização Universal", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-02-16", name: "Carnaval", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-02-17", name: "Carnaval", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-04-03", name: "Sexta-feira Santa", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-04-21", name: "Tiradentes", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-05-01", name: "Dia do Trabalho", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-06-04", name: "Corpus Christi", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-09-07", name: "Independência do Brasil", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-10-12", name: "Nossa Senhora Aparecida", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-11-02", name: "Finados", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-11-15", name: "Proclamação da República", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
  { date: "2026-12-25", name: "Natal", scope: "NACIONAL", isActive: true, createdAt: now, updatedAt: now },
]);
